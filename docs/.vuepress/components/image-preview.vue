<template>
    <div class="image-preview">
        <van-image fit="cover" :heght="height || '100%'" :width="width || '100%'" :style="setStyle" :src="getUrl" @click="clickPreview(getUrl)" />
        <van-image-preview v-model="show" :images="images" @click.native="clickShow">
